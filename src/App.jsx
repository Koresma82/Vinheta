...
import { Wine, BookOpen, BarChart3, Star, Target, Eye, LogOut } from 'lucide-react'
import './App.css'
  ...
  return (
    <div className="min-h-screen" style={{ background: 'linear-gradient(135deg, #1a0e0e 0%, #2d1b1b 100%)' }}>
      ...
      <footer className="mt-12 border-t" style={{ borderColor: 'rgba(212, 175, 55, 0.2)' }}>
        <div className="max-w-7xl mx-auto px-6 py-8 text-center text-amber-100/50 text-sm">
          <p>Vinheta | O vinho certo para o seu prato</p>
          <p className="mt-2">© 2026 Vinheta. Todos os direitos reservados.</p>
        </div>
      </footer>
    </div>
  )
